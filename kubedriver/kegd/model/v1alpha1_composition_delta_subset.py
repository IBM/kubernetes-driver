...
class V1alpha1KegdCompositionDeltaSubset(object):

    openapi_types = {
        'objects': 'list[V1alpha1ObjectDelta]',
        'helm_releases': 'list[V1alpha1HelmReleaseDelta]',
    }
    ...
    def __eq__(self, other):
        if not isinstance(other, V1alpha1KegdCompositionDeltaSubset):
            return False
